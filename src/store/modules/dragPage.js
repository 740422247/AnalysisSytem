...
const actions = {
  ...
  [types.GetDistrictByYear]: function ({ commit }, params = { year: 2019 }) {
    // 待修改
  ...
  [types.getModules]: function ({ commit }, params) {
    const result = [
      { "type": "jkGraph:barChart", "choice": [{ "id": "lineChart", "name": "折线图" }, { "id": "twoBarChart", "name": "双向柱状图" }, { "id": "barChart", "name": "柱状图" }], "className": ["jk-col-24", "handle"], "style": { "height": "300px" }, "isHandle": false, "text": "区县柱状图", "path": "", "border": true, "grid": true, "service": { "api": "", "params": {}, "data": {} }, "option": {}, "data": { "symbol": ["2020年{name}:{value}人"], "value": [[1.39603, 1.94, 1.92, 9.54925, 6.605, 4.66, 1.881084, 1, 1, 8, 6, 5.44]], "label": ["1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "10月", "11月", "12月"], "choice": { "showX": true, "showY": true }, "path": [] }, "argument": { "arguments": ["CODE", "NAME", "PERSON", "PROJECTS", "MONEY"], "path": "GetDistrictByYear", "moduleName": "区县柱状图", "apiArgument": [{ "value": "CODE", "label": "区县代码" }, { "value": "NAME", "label": "区县名称" }, { "value": "PERSON", "label": "人数#人" }, { "value": "PROJECTS", "label": "项目数#个" }, { "value": "MONEY", "label": "金额#万元" }] } },
      { "type": "jkGraph:lineChart", "choice": [{ "id": "lineChart", "name": "折线图" }, { "id": "twoBarChart", "name": "双向柱状图" }, { "id": "barChart", "name": "柱状图" }], "className": ["jk-col-24", "handle"], "style": { "height": "300px" }, "isHandle": false, "text": "模块2", "path": "", "border": true, "grid": true, "service": { "api": "", "params": {}, "data": {} }, "option": {}, "data": { "symbol": ["2020年{name}:{value}万元", "2020年{name}:{value}万次"], "all": [], "value": [[3864.39603, 1508.94], [11125, 1108.94]], "choice": { "showX": true, "showY": true }, "label": ["1月", "2月"], "path": [] }, "argument": { "arguments": ["CODE", "NAME", "PERSON", "PROJECTS", "MONEY"], "path": "GetDistrictByYear", "moduleName": "模块2", "apiArgument": [{ "value": "CODE", "label": "编码" }, { "value": "NAME", "label": "区县名称" }, { "value": "PERSON", "label": "人数#人" }, { "value": "PROJECTS", "label": "项目数#个" }, { "value": "MONEY", "label": "金额#万元" }] } },
      { "type": "jkRank:singleRank", "choice": [{ "id": "jkRank:singleRank", "name": "单行排行榜" }, { "id": "jkRank:multipleRank", "name": "多行排行榜" }, { "id": "jkRank:batteryRank", "name": "电池排行榜" }], "isHandle": false, "className": ["jk-col-24", "handle"], "style": { "height": "300px" }, "path": "", "border": true, "grid": true, "service": { "api": "", "params": {}, "data": {} }, "data": { "symbol": [""], "all": [666], "value": [10, 20, 5555, 200], "label": [], "path": [] }, "argument": { "arguments": ["MONEY", "PERSON", "PROJECTS", "NAME", "CODE"], "path": "GetDistrictByYear", "apiArgument": [{ "value": "NAME", "label": "区县名称" }, { "value": "CODE", "label": "编码" }, { "value": "MONEY", "label": "金额#万元" }, { "value": "PERSON", "label": "人数#人" }, { "value": "PROJECTS", "label": "项目数#个" }] } },
      { "type": "jkRank:multipleRank", "choice": [{ "id": "jkRank:singleRank", "name": "单行排行榜" }, { "id": "jkRank:multipleRank", "name": "多行排行榜" }, { "id": "jkRank:batteryRank", "name": "电池排行榜" }], "isHandle": false, "className": ["jk-col-24", "handle"], "style": { "height": "300px" }, "text": "区县数据2", "path": "", "border": true, "grid": true, "service": { "api": "", "params": {}, "data": {} }, "data": { "symbol": ["万元", "万次"], "all": [666666, 6666], "value": [[1111, 222, 333], [111, 333, 444]], "label": ["盐湖区", "永济市", "垣曲县"], "path": ["#", "#", "#"] }, "argument": { "arguments": ["NAME", "CODE", "PERSON", "PROJECTS", "MONEY"], "moduleName": "区县数据2", "path": "GetDistrictByYear", "apiArgument": [{ "value": "NAME", "label": "区县名称" }, { "value": "CODE", "label": "区县编码" }, { "value": "PERSON", "label": "人数#人" }, { "value": "PROJECTS", "label": "项目数#个" }, { "value": "MONEY", "label": "金额#万元" }] } },
      { "type": "jkGraph:twoBarChart", "choice": [{ "id": "lineChart", "name": "折线图" }, { "id": "twoBarChart", "name": "双向柱状图" }, { "id": "barChart", "name": "柱状图" }], "className": ["jk-col-24", "handle"], "style": { "height": "300px" }, "isHandle": false, "text": "对比柱", "path": "", "border": true, "grid": true, "service": { "api": "", "params": {}, "data": {} }, "option": {}, "data": { "symbol": ["男:{value}人", "女:{value}人"], "all": [], "value": [[4968, 5623, 14231, 30323, 41854, 41855, 27263, 8488, 605], [-4388, -3351, -6729, -12813, -14396, -21332, -23705, -12856, -1995]], "label": ["0-19岁", "20-29岁", "30-39岁", "40-49岁", "50-59岁", "60-69岁", "70-79岁", "80-89岁", "90岁以上"], "choice": { "showX": true, "showY": true }, "path": [] }, "argument": { "arguments": ["NAME", "CODE", "PERSON", "PROJECTS", "MONEY"], "path": "GetDistrictByYear", "moduleName": "对比柱", "apiArgument": [{ "value": "NAME", "label": "区县名称" }, { "value": "CODE", "label": "区县编码" }, { "value": "PERSON", "label": "人数#人" }, { "value": "PROJECTS", "label": "项目数#个" }, { "value": "MONEY", "label": "金额#万元" }] } }
    ]

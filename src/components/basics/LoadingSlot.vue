<template>
  <div class="LoadingSlot">
    <slot></slot>
    <div class="loading" id="bonfire-pageloader" v-show="loading">
...
export default {
  ...
  watch: {
    show: {
      ...
      //   this.$emit('PageIndex',newVal)
      //   window.console.log("跳转到新页码：", newVal);
      // this.getData();
    }
  }
};
...
#bonfire-pageloader {
  ...
  background-color: rgba(17, 17, 79, 0.8);
}
/* loading icon color */
#bonfire-pageloader svg {
  fill: rgba(0, 99, 246, 0.7);
}

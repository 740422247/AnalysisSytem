 ...
 * @LastEditors: wss
 * @LastEditTime: 2021-01-04 10:05:56
-->
<!-- jkCard -->
<template>
  <jkCard
    class="jkCard cardCol"
            ...
            >
              <template v-if="item.label">
                ...
                <div>
                  ...
                  <h3>
                    <span :style="dataList.valStyle ? dataList.valStyle : ''">{{
                      item.value
                    }}</span>
                    <i
                      class="Unit"
...
export default {
  ...
  computed: {
    ...
    //     for (let i = 0; i < count - arrTemp[index].length; i++) {
    //       arrTemp[index].push({});
    //     }
    //   }
    //   return arrTemp;
